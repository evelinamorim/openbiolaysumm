...
with open("../UMLS_Files/umls_rels.txt", "r") as in_file:
    lines = in_file.readlines()
...
for split in ["train", "val", "test"]: 
    ...
    out_file = open(f"../DSplit/{split}_disc_graphs_complete.jsonl", "w")

    with open(f"../DSplit/{split}_disc_graphs.jsonl", "r") as in_file:
